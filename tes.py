...
def quality_control_check(jobs_list, model_id, logger):
    ...
    """
    logger.log("🕵️‍♂️ Memulai Quality Control (QC) untuk semua job...",custom="error")
    ...
    logger.log(f"✅ QC Selesai. Ringkasan dari {total_jobs} job yang terdeteksi:", custom="error")
